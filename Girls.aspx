<%@ Page Title="Girls | Bubba Knits" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Girls.aspx.vb" Inherits="Girls" %>
...
<center>
      <%--  <asp:DataList ID="DataList1" runat="server" DataSourceID="XmlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
             ...
             <asp:DataList ID="DataList2" runat="server" DataSourceID="Sqlgirls" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="girls.xml"></asp:XmlDataSource>
     ...
     <asp:SqlDataSource ID="Sqlgirls" runat="server" ConnectionString="<%$ ConnectionStrings:PPConnectionString %>" ProviderName="System.Data.SqlClient"
        SelectCommand="proc_BK_Show_girls" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
</asp:Content>
