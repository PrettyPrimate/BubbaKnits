<%@ Page Title="New Born | Bubba Knits" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="New_Born.aspx.vb" Inherits="New_Born" %>
...
<center>
    <%--    <asp:DataList ID="DataList1" runat="server" DataSourceID="XmlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
             ...
             <asp:DataList ID="DataList2" runat="server" DataSourceID="Sqlnew" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="newborn.xml"></asp:XmlDataSource>

       <asp:SqlDataSource ID="Sqlnew" runat="server" ConnectionString="<%$ ConnectionStrings:PPConnectionString %>" ProviderName="System.Data.SqlClient"
        SelectCommand="proc_BK_Show_new_born" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
</asp:Content>