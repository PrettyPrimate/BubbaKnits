<%@ Page Title="Accessories | Bubba Knits" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Accessories.aspx.vb" Inherits="Accessories" %>
...
<center>
       <%-- <asp:DataList ID="DataList1" runat="server" DataSourceID="XmlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal">
           ...
           <asp:DataList ID="DataList2" runat="server" DataSourceID="Sqlaccs" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="accessories.xml"></asp:XmlDataSource>

     <asp:SqlDataSource ID="Sqlaccs" runat="server" ConnectionString="<%$ ConnectionStrings:PPConnectionString %>" ProviderName="System.Data.SqlClient"
        SelectCommand="proc_BK_Show_accessories" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
</asp:Content>
