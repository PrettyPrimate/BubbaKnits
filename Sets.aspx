<%@ Page Title="Sets | Bubba Knits" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Sets.aspx.vb" Inherits="Sets" %>
...
<center>
     <%--   <asp:DataList ID="DataList1" runat="server" DataSourceID="XmlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
             ...
             <asp:DataList ID="DataList2" runat="server" DataSourceID="Sqlsets" RepeatColumns="3" RepeatDirection="Horizontal">
            <ItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="sets.xml"></asp:XmlDataSource>

      <asp:SqlDataSource ID="Sqlsets" runat="server" ConnectionString="<%$ ConnectionStrings:PPConnectionString %>" ProviderName="System.Data.SqlClient"
        SelectCommand="proc_BK_Show_sets" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
</asp:Content>
